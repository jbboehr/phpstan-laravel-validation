...
class RulesInferenceTest extends \PHPStan\Testing\TypeInferenceTestCase
{
    ...
    public static function dataFileAsserts(): iterable
    {
        ...
        yield from self::gatherAssertTypes(__DIR__ . '/rules/aliases.php');
        ...
        yield from self::gatherAssertTypes(__DIR__ . '/rules/array.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/ascii.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/before.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/before-or-equal.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/boolean.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/confirmed.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/current-password.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/date.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/date-equals.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/date-format.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/decimal.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/declined.php');
        ...
        yield from self::gatherAssertTypes(__DIR__ . '/rules/exclude-with.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/exclude-without.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/file.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/image.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/in.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/integer.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/ip.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/ipv4.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/ipv6.php');
        ...
        yield from self::gatherAssertTypes(__DIR__ . '/rules/multiple-of.php');
        ...
        yield from self::gatherAssertTypes(__DIR__ . '/rules/uppercase.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/url.php');
        yield from self::gatherAssertTypes(__DIR__ . '/rules/uuid.php');
    }
