...
final class InferenceAuditCases
{
    ...
    public static function cases(): array
    {
        ...
        return [
            ...
            'digits.true' => $case(true, 'required|digits:1', 'minor-version coercion'),
            'digits.false' => $case(false, 'digits:0', 'minor-version coercion'),
            'digits.null' => $case(null, 'digits:0', 'minor-version coercion'),
            'digits.stringable' => [
                'data' => static fn (): array => ['value' => new \Illuminate\Support\Stringable('1')],
                'rules' => ['value' => 'required|digits:1'],
                'concern' => 'minor-version coercion',
                'precision' => true,
            ],
            'digits_between.integer' => $case(12, 'required|digits_between:1,3'),
            'digits_between.true' => $case(true, 'required|digits_between:1,3', 'minor-version coercion'),
            'digits_between.false' => $case(false, 'digits_between:0,3', 'minor-version coercion'),
            'digits_between.null' => $case(null, 'digits_between:0,3', 'minor-version coercion'),
            'digits_between.stringable' => [
                'data' => static fn (): array => ['value' => new \Illuminate\Support\Stringable('1')],
                'rules' => ['value' => 'required|digits_between:1,3'],
                'concern' => 'minor-version coercion',
                'precision' => true,
            ],
            ...
            'max_digits.true' => $case(true, 'required|max_digits:3', 'minor-version coercion'),
            'max_digits.false' => $case(false, 'required|max_digits:3', 'minor-version coercion'),
            'max_digits.null' => $case(null, 'max_digits:3', 'minor-version coercion'),
            'max_digits.stringable' => [
                'data' => static fn (): array => ['value' => new \Illuminate\Support\Stringable('1')],
                'rules' => ['value' => 'required|max_digits:3'],
                'concern' => 'minor-version coercion',
                'precision' => true,
            ],
            'min_digits.integer' => $case(12, 'required|min_digits:2'),
            'min_digits.too_few' => $case(1, 'required|min_digits:2', 'predicate precision'),
            'min_digits.true' => $case(true, 'required|min_digits:1', 'minor-version coercion'),
            'min_digits.false' => $case(false, 'min_digits:0', 'minor-version coercion'),
            'min_digits.null' => $case(null, 'min_digits:0', 'minor-version coercion'),
            'min_digits.stringable' => [
                'data' => static fn (): array => ['value' => new \Illuminate\Support\Stringable('1')],
                'rules' => ['value' => 'required|min_digits:1'],
                'concern' => 'minor-version coercion',
                'precision' => true,
            ],
    ...
    public static function inventory(): array
    {
        return [
            ...
            'digit-count coercion' => [
                'status' => 'probed',
                'evidence' => [
                    'digits.true', 'digits.false', 'digits.null', 'digits.stringable',
                    'digits_between.true', 'digits_between.false', 'digits_between.null', 'digits_between.stringable',
                    'max_digits.true', 'max_digits.false', 'max_digits.null', 'max_digits.stringable',
                    'min_digits.true', 'min_digits.false', 'min_digits.null', 'min_digits.stringable',
                ],
            ],
