...
assertType('array{required_value: DateTimeInterface|non-empty-string, optional_value?: DateTimeInterface|string}', $validated);
assertType('DateTimeInterface|non-empty-string', $validated['required_value']);
assertType('DateTimeInterface|string', $validated['optional_value']);
