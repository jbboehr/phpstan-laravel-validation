...
[`AssertsLaravelValidation`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/Support/AssertsLaravelValidation.php)
...
[`PresenceLaravelRuntimeTest`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/PresenceLaravelRuntimeTest.php) rather
...
are described in [Development](development.md). The Infection configuration
