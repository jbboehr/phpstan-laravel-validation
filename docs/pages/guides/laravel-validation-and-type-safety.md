...
The extension does not make Laravel normalize values or invent contracts
for arbitrary runtime code. It describes supported combinations covered by
conformance tests. Finite tests do not prove universal soundness. An ugly
union is often evidence of ugly framework behavior rather than analyzer
failure.
...
The [exhaustive Nix matrix](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/.github/workflows/ci.yml) runs every supported
...
[Laravel-version inference audit](../contributing/laravel-version-inference-audit.md) records
boundary profiles, runtime snapshots, and audit limitations.

Runtime methods in the table below are defined in
[`tests/LaravelInferenceTest.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/LaravelInferenceTest.php) and
[`tests/CustomRulesLaravelRuntimeTest.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/CustomRulesLaravelRuntimeTest.php).
...
| HTTP normalization changes blank behavior | `LaravelInferenceTest::testDefaultHttpInputNormalizationChangesOptionalBlankBehavior`, `testTrimStringsAloneDoesNotEliminateBlankStringBypass`, and `testDefaultPasswordTrimExceptionVariesByLaravelMajor` | [`tests/normalized/request.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/normalized/request.php), [`tests/structure/request.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/structure/request.php), and [`tests/version-aware/inference.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/version-aware/inference.php) |
| Conditional acceptance broadens values | `LaravelInferenceTest::testConditionalValueRulesRemainConservative` | [`tests/rules/accepted-if.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/rules/accepted-if.php) |
| Conditional exclusion changes shape | `LaravelInferenceTest::testConditionalExclusionChangesTheValidatedShape` | [`tests/rules/exclude-if.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/rules/exclude-if.php) |
| Definite conditional presence and absence can refine shape experimentally | `ConditionalPresenceLaravelRuntimeTest::testConditionalPresenceMatchesExperimentalInference`, `testActiveConditionalPresenceRulesRejectTheOppositeShape`, `testConditionalPresentRulesFollowRuntimeAndInferenceBoundary`, and the exact-profile [`conditional-presence-rule-audit.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/scripts/conditional-presence-rule-audit.php) probe | [`tests/conditional-presence/inference.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/conditional-presence/inference.php), [`tests/conditional-presence/before-introduction.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/conditional-presence/before-introduction.php), and `TypeResolverTest::testExperimentalConditionalPresenceInferenceResolvesDefiniteConditions` |
| Required wildcard descendants may match nothing | `LaravelInferenceTest::testRequiredWildcardDescendantDoesNotRequireMissingParent` | [`tests/structure/wildcard.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/structure/wildcard.php) |
| Bare arrays preserve nested keys | `LaravelInferenceTest::testArrayRuleWithoutKeyParametersPreservesNestedKeys` | [`tests/rules/array.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/rules/array.php) |
| Array key lists reject undeclared keys | `LaravelInferenceTest::testArrayRuleKeyParametersRejectUndeclaredNestedKeys` | [`tests/rules/array.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/rules/array.php) |
| Nested child rules project validated keys | `LaravelInferenceTest::testParentAndChildRulesAcceptRuntimeOutput` | [`tests/structure/parent-rules.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/structure/parent-rules.php) |
| Factory configuration changes nested projection | `LaravelInferenceTest::testFactoryUnvalidatedArrayKeyModesMatchInference` | [`tests/include-unvalidated-array-keys/inference.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/include-unvalidated-array-keys/inference.php) |
| Parameterized arrays preserve the permitted parent around nested rules | `PresenceLaravelRuntimeTest::testRuntimeProjection` (named parameterized-parent cases) and the version-audit snapshots | [`tests/rules/missing.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/rules/missing.php) and `TypeResolverTest::testParameterizedArrayParentIsPreservedAroundNestedRules` |
...
| A parent-typed FormRequest can receive child output that violates the parent's rules contract | `FormRequestLaravelRuntimeTest::testPolymorphicChildCanReplaceTheParentsRulesContract`, `testFinalRulesMethodDoesNotPreventAChildFromReplacingValidation`, `testGrandchildCanChangeRulesThroughAnAbstractIntermediate`, `testChildCanOverrideSafeWithoutChangingValidated`, and `testAnonymousChildCanChangeTheParentContract` | [`tests/form-request/polymorphism.php`](https://github.com/jbboehr/phpstan-laravel-validation/blob/master/tests/form-request/polymorphism.php), `FormRequestTypeRegistryTest::testReceiverIncludesEveryKnownConcreteContract`, and `FormRequestResultCacheTest::testDescendantChangesInvalidateCachedParentCaller` |
