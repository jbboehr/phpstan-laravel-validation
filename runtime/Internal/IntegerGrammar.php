 ...
 *     `'-0'` is accepted and normalizes to `0`.
 *
...
final class IntegerGrammar
{
     ...
     *
     * Passing an `int` through unchanged keeps already-canonical application
     * values canonical as well. It also makes a fresh validator behave the
     * same whether its caller supplied `42` or the canonical string `'42'`.
     */
